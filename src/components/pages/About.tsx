          ...
          <div className="text-center">
            <div className="inline-flex flex-col items-center gap-4 px-8 py-6 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-sm rounded-2xl border border-white/10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300 text-sm font-medium">Always excited to work on challenging projects and learn new technologies</span>
                <Star className="h-5 w-5 text-yellow-300" />
              </div>
              <div className="flex flex-wrap justify-center gap-2 mt-2">
                {["Collaboration", "Innovation", "Quality", "Growth"].map((tag, index) => (
                  <span 
                    key={index}
